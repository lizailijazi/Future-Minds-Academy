export default function Help(){
    return(
        <div>      <div className="row faq-section m-10 gap-9">
        <div className="col-1">
        ...
        <div className="col-1">
          ...
          <div className="faq-item-content">
            <p>
              When you buy Sassio, you get all you see in the demo but the
              images. We include SASS files for styling, complete JS files with
              comments, all HTML variations. Besides, we include all mobile PSD
              mockups.
            </p>
          </div>
          <div className="faq-item">
