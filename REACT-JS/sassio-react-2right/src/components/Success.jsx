        ...
        <div>
         ...
         <div className="path-succes">
            <div className="col-2 gap-2">
               <button className="speciale-1 just-start">WE ARE YOUR ONLY</button>
               {/* <br></br> */}
               ...
               <div className="row gap-2 m-3 align-start">
                  ...
                  <div className="col-5">
                     <h3 className="dark">Mail Management</h3>
                     {/* <br></br> */}
               ...
               <div className="row gap-2">
                  ...
                  <div className="col-5">
                     <h3 className="dark">Customers Tracking</h3>
                     {/* <br></br> */}
                     <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet
                         {/* <br></br> */}
                         aut autem eum laudantium quas
               ...
               <div className="row gap-2">
                  ...
                  <div className="col-5">
                     <h3 className="dark">Advanced Reporting</h3>
                     {/* <br></br> */}
                     <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet
                         {/* <br></br> */}
                         aut autem eum laudantium quas
